...
import {H1,H2,TouchFeedback,P,Button, TransferMoney, FundWallet, 
  Warning,
  AddMoney,
  SavingsLoader,
  AddBVN,
                              ...
                              item === "Select money" ? (
                                <React.Fragment>
                                  ...
                                  <Container
                                    ...
                                    paddingRight={1}
                                  >
                                    <P fontSize={FONTSIZE.small} color={Colors.white} textAlign="center">This is the amount you have saved across all savings plans and goals.</P>
                                  </Container>
